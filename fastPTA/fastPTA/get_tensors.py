...
def transmission_function(frequencies, T_obs):
    ...
    """
    # Alisha: I assume same for us 05/09
...
def gamma_pulsar_pair_analytical(
    ...
    """
    # Alisha: rewriting this at first just for the I and not V to be able to compare with known results
            # 05/09
...
def gamma_analytical(theta, phi, theta_k, phi_k):
    ...
    """
    # Alisha: 05/09 leaving this array as is
